...
import ma.zs.univ.service.facade.utilisateur.doc.DocumentAcessShareUtilisateurService;
...
@RestController
@RequestMapping("/api/utilisateur/documentAcessShare/")
public class DocumentAcessShareRestUtilisateur {
    ...
    @Autowired private DocumentAcessShareUtilisateurService service;

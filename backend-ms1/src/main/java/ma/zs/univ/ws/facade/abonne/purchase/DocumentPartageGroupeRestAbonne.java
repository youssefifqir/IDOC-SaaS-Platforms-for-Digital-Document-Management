...
@RestController
@RequestMapping("/api/abonne/documentPartageGroupe/")
public class DocumentPartageGroupeRestAbonne {
    ...
    @Autowired private DocumentPartageGroupeAbonneService service;

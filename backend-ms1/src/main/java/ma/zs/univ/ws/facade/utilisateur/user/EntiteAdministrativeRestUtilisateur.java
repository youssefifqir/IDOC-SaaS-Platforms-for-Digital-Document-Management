package  ma.zs.univ.ws.facade.utilisateur.user;
...
@RestController
@RequestMapping("/api/utilisateur/entiteAdministrative/")
public class EntiteAdministrativeRestUtilisateur {
    ...
    @Autowired private EntiteAdministrativeUtilisateurService service;

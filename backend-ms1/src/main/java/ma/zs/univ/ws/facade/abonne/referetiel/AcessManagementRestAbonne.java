package  ma.zs.univ.ws.facade.abonne.referetiel;
...
@RestController
@RequestMapping("/api/abonne/acessManagement/")
public class AcessManagementRestAbonne {
    ...
    @Autowired private AcessManagementAbonneService service;

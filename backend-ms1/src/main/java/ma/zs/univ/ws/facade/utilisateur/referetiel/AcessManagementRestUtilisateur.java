...
import ma.zs.univ.service.facade.utilisateur.referetiel.AcessManagementUtilisateurService;
...
@RestController
@RequestMapping("/api/utilisateur/acessManagement/")
public class AcessManagementRestUtilisateur {
    ...
    @Autowired private AcessManagementUtilisateurService service;

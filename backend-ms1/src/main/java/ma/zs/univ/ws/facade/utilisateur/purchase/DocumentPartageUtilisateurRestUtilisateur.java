...
@RestController
@RequestMapping("/api/utilisateur/documentPartageUtilisateur/")
public class DocumentPartageUtilisateurRestUtilisateur {
    ...
    @Autowired private DocumentPartageUtilisateurUtilisateurService service;

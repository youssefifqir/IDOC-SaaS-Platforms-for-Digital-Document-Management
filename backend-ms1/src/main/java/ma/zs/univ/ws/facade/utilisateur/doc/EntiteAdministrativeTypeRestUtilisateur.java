...
@RestController
@RequestMapping("/api/utilisateur/entiteAdministrativeType/")
public class EntiteAdministrativeTypeRestUtilisateur {
    ...
    @Autowired private EntiteAdministrativeTypeUtilisateurService service;

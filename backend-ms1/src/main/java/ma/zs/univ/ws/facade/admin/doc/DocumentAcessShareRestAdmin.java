...
import ma.zs.univ.service.facade.admin.doc.DocumentAcessShareAdminService;
...
public class DocumentAcessShareRestAdmin {
    ...
    @Autowired private DocumentAcessShareAdminService service;

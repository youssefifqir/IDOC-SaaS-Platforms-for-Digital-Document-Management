...
@RestController
@RequestMapping("/api/utilisateur/documentFieldState/")
public class DocumentFieldStateRestUtilisateur {
    ...
    @Autowired private DocumentFieldStateUtilisateurService service;

...
@RestController
@RequestMapping("/api/utilisateur/documentPartageGroupe/")
public class DocumentPartageGroupeRestUtilisateur {
    ...
    @Autowired private DocumentPartageGroupeUtilisateurService service;

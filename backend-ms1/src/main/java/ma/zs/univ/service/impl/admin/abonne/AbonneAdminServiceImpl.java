package ma.zs.univ.service.impl.admin.abonne;
...
import java.util.List;
@Service
public class AbonneAdminServiceImpl implements AbonneAdminService {
    ...
    public Abonne create(Abonne t) {
        ...
        // Create Utilisateur associated with the Abonne
        Utilisateur utilisateur = new Utilisateur(t.getUsername());
        utilisateur.setPassword(t.getPassword());
        utilisateur.setEnabled(t.getEnabled());
        utilisateur.setAccountNonExpired(t.getAccountNonExpired());
        utilisateur.setAccountNonLocked(t.getAccountNonLocked());
        utilisateur.setCredentialsNonExpired(t.getCredentialsNonExpired());
        utilisateur.setPasswordChanged(t.getPasswordChanged());
        utilisateur.setEmail(t.getEmail());
        utilisateur.setFirstName(t.getFirstName());
        utilisateur.setLastName(t.getLastName());
        utilisateur.setPhone(t.getPhone());
        utilisateur.setAbonne(mySaved);

        utilisateurAdminService.create(utilisateur);

        // Create MinIO space for the Abonne
    ...
    private @Autowired UtilisateurAdminService utilisateurAdminService;

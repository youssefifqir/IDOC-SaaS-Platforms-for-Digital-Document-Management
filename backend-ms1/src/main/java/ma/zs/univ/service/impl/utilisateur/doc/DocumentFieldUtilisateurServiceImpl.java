...
import ma.zs.univ.service.facade.utilisateur.doc.FieldUtilisateurService ;
import ma.zs.univ.bean.core.doc.Field ;
import ma.zs.univ.service.facade.utilisateur.doc.DocumentFieldStateUtilisateurService ;
...
import java.util.List;
@Service
public class DocumentFieldUtilisateurServiceImpl implements DocumentFieldUtilisateurService {
    ...
    @Autowired
    private FieldUtilisateurService fieldService ;
    @Autowired
    private DocumentFieldStateUtilisateurService documentFieldStateService ;
    @Autowired

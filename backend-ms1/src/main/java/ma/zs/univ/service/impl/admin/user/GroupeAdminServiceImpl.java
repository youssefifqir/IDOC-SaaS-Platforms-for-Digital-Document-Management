package ma.zs.univ.service.impl.admin.user;
...
import ma.zs.univ.service.facade.admin.purchase.GroupeUtilisateurAdminService ;
...
import java.util.List;
@Service
public class GroupeAdminServiceImpl implements GroupeAdminService {

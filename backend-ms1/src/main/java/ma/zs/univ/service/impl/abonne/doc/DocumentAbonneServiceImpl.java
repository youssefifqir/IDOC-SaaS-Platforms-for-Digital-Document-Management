...
import ma.zs.univ.service.facade.abonne.doc.DocumentStateAbonneService ;
import ma.zs.univ.bean.core.doc.DocumentState ;
import ma.zs.univ.service.facade.abonne.purchase.DocumentPartageGroupeAbonneService ;
...
import ma.zs.univ.service.facade.abonne.doc.DocumentCategorieAbonneService ;
...
import ma.zs.univ.service.facade.abonne.doc.DocumentTypeAbonneService ;
...
import java.util.List;
@Service
public class DocumentAbonneServiceImpl implements DocumentAbonneService {
    ...
    @Autowired
    private DocumentStateAbonneService documentStateService ;
    @Autowired
    private DocumentPartageGroupeAbonneService documentPartageGroupeService ;
    @Autowired
    private DocumentTagAbonneService documentTagService ;
    @Autowired
    private DocumentCategorieAbonneService documentCategorieService ;
    @Autowired
    private DocumentFieldAbonneService documentFieldService ;
    @Autowired
    private DocumentPartageUtilisateurAbonneService documentPartageUtilisateurService ;
    @Autowired
    private DocumentTypeAbonneService documentTypeService ;
    @Autowired

...
import java.util.List;
@Service
public class EntiteAdministrativeAbonneServiceImpl implements EntiteAdministrativeAbonneService {
    ...
    public EntiteAdministrative create(EntiteAdministrative t) {
        ...
        if (loaded == null) {
            saved = dao.save(t);
            minIOService.createFoldersForEntity(saved,"yarbi");
        }else {
            saved = null;
        }
        return saved;
    ...
    @Autowired
    private AbonneAbonneService abonneService ;
    @Autowired
    private EntiteAdministrativeTypeAbonneService entiteAdministrativeTypeService ;
    @Autowired

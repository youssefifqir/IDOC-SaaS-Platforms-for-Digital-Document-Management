...
import ma.zs.univ.service.facade.utilisateur.doc.DocumentTagUtilisateurService ;
...
import ma.zs.univ.service.facade.utilisateur.purchase.DocumentPartageUtilisateurUtilisateurService ;
...
import java.util.List;
@Service
public class DocumentUtilisateurServiceImpl implements DocumentUtilisateurService {
    ...
    @Autowired
    private DocumentStateUtilisateurService documentStateService ;
    @Autowired
    private DocumentPartageGroupeUtilisateurService documentPartageGroupeService ;
    @Autowired
    private DocumentTagUtilisateurService documentTagService ;
    @Autowired
    private DocumentCategorieUtilisateurService documentCategorieService ;
    @Autowired
    private DocumentFieldUtilisateurService documentFieldService ;
    @Autowired
    private DocumentPartageUtilisateurUtilisateurService documentPartageUtilisateurService ;
    @Autowired
    private DocumentTypeUtilisateurService documentTypeService ;
    @Autowired

...
@Component({
  selector: 'app-acess-management-view-utilisateur',
  templateUrl: './acess-management-view-utilisateur.component.html'
})
export class AcessManagementViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: AcessManagementUtilisateurService){

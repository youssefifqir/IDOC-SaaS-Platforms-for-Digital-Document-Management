...
@Component({
  selector: 'app-acess-management-list-utilisateur',
  templateUrl: './acess-management-list-utilisateur.component.html'
})
export class AcessManagementListUtilisateurComponent implements OnInit {

...
@Component({
  selector: 'app-acess-share-list-utilisateur',
  templateUrl: './acess-share-list-utilisateur.component.html'
})
export class AcessShareListUtilisateurComponent implements OnInit {

...
@Component({
  selector: 'app-utilisateur-list-utilisateur',
  templateUrl: './utilisateur-list-utilisateur.component.html'
})
export class UtilisateurListUtilisateurComponent implements OnInit {

    protected fileName = 'Utilisateur';
    ...
    constructor( private service: UtilisateurUtilisateurService  , private abonneService: AbonneUtilisateurService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<UtilisateurDto>();
    ...
    public async edit(dto: UtilisateurDto) {
    ...
    public async view(dto: UtilisateurDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: UtilisateurDto) {
    ...
    public async duplicate(dto: UtilisateurDto) {
    ...
    public exportPdf(dto: UtilisateurDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<UtilisateurDto> {
        return this.service.selections;
    }

    set selections(value: Array<UtilisateurDto>) {

...
@Component({
  selector: 'app-groupe-view-utilisateur',
  templateUrl: './groupe-view-utilisateur.component.html'
})
export class GroupeViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: GroupeUtilisateurService, private groupeUtilisateurService: GroupeUtilisateurUtilisateurService, private utilisateurService: UtilisateurUtilisateurService){

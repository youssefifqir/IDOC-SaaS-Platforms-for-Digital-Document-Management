...
@Component({
  selector: 'app-abonne-view-utilisateur',
  templateUrl: './abonne-view-utilisateur.component.html'
})
export class AbonneViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: AbonneUtilisateurService, private entiteAdministrativeService: EntiteAdministrativeUtilisateurService){

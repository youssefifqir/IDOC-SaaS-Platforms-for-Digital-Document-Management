...
@Component({
  selector: 'app-field-view-utilisateur',
  templateUrl: './field-view-utilisateur.component.html'
})
export class FieldViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: FieldUtilisateurService){

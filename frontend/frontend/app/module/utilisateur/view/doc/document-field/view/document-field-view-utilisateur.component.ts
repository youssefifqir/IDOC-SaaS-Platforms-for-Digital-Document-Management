...
@Component({
  selector: 'app-document-field-view-utilisateur',
  templateUrl: './document-field-view-utilisateur.component.html'
})
export class DocumentFieldViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: DocumentFieldUtilisateurService, private fieldService: FieldUtilisateurService, private documentFieldStateService: DocumentFieldStateUtilisateurService, private documentService: DocumentUtilisateurService){

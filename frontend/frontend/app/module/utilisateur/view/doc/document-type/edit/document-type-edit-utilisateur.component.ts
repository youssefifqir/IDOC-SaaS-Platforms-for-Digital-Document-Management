...
@Component({
  selector: 'app-document-type-edit-utilisateur',
  templateUrl: './document-type-edit-utilisateur.component.html'
})
export class DocumentTypeEditUtilisateurComponent implements OnInit {

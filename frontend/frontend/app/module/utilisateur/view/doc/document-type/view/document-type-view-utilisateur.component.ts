...
@Component({
  selector: 'app-document-type-view-utilisateur',
  templateUrl: './document-type-view-utilisateur.component.html'
})
export class DocumentTypeViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: DocumentTypeUtilisateurService){

...
@Component({
  selector: 'app-document-type-create-utilisateur',
  templateUrl: './document-type-create-utilisateur.component.html'
})
export class DocumentTypeCreateUtilisateurComponent  implements OnInit {
   ...
   private _validDocumentTypeLibelle = true;
	...
	constructor(private service: DocumentTypeUtilisateurService , @Inject(PLATFORM_ID) private platformId? ) {

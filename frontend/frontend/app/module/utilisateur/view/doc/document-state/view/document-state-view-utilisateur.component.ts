...
@Component({
  selector: 'app-document-state-view-utilisateur',
  templateUrl: './document-state-view-utilisateur.component.html'
})
export class DocumentStateViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: DocumentStateUtilisateurService){

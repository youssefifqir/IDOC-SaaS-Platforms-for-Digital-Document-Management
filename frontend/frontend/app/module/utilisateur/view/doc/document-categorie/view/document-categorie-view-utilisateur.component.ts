...
@Component({
  selector: 'app-document-categorie-view-utilisateur',
  templateUrl: './document-categorie-view-utilisateur.component.html'
})
export class DocumentCategorieViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: DocumentCategorieUtilisateurService){

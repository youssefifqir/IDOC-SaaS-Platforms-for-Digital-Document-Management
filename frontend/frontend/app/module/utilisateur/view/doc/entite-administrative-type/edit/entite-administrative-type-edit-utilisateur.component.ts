...
@Component({
  selector: 'app-entite-administrative-type-edit-utilisateur',
  templateUrl: './entite-administrative-type-edit-utilisateur.component.html'
})
export class EntiteAdministrativeTypeEditUtilisateurComponent implements OnInit {

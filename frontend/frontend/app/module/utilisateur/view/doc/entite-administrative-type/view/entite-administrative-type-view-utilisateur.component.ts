...
@Component({
  selector: 'app-entite-administrative-type-view-utilisateur',
  templateUrl: './entite-administrative-type-view-utilisateur.component.html'
})
export class EntiteAdministrativeTypeViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: EntiteAdministrativeTypeUtilisateurService){

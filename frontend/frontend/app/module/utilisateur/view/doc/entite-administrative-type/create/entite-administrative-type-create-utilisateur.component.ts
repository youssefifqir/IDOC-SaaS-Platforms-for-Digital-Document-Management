...
@Component({
  selector: 'app-entite-administrative-type-create-utilisateur',
  templateUrl: './entite-administrative-type-create-utilisateur.component.html'
})
export class EntiteAdministrativeTypeCreateUtilisateurComponent  implements OnInit {

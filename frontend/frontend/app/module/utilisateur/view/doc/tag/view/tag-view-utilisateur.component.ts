...
@Component({
  selector: 'app-tag-view-utilisateur',
  templateUrl: './tag-view-utilisateur.component.html'
})
export class TagViewUtilisateurComponent implements OnInit {
    ...
    constructor(private service: TagUtilisateurService){

...
@Component({
  selector: 'app-abonne-view-abonne',
  templateUrl: './abonne-view-abonne.component.html'
})
export class AbonneViewAbonneComponent implements OnInit {
    ...
    constructor(private service: AbonneAbonneService, private entiteAdministrativeService: EntiteAdministrativeAbonneService){

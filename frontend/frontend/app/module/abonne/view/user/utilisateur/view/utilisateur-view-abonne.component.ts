...
@Component({
  selector: 'app-utilisateur-view-abonne',
  templateUrl: './utilisateur-view-abonne.component.html'
})
export class UtilisateurViewAbonneComponent implements OnInit {
    ...
    constructor(private service: UtilisateurAbonneService, private abonneService: AbonneAbonneService){

...
@Component({
  selector: 'app-entite-administrative-list-abonne',
  templateUrl: './entite-administrative-list-abonne.component.html'
})
export class EntiteAdministrativeListAbonneComponent implements OnInit {

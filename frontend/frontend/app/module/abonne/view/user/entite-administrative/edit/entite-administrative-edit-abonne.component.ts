...
@Component({
  selector: 'app-entite-administrative-edit-abonne',
  templateUrl: './entite-administrative-edit-abonne.component.html'
})
export class EntiteAdministrativeEditAbonneComponent implements OnInit {

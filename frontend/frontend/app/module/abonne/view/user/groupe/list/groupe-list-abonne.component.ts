...
@Component({
  selector: 'app-groupe-list-abonne',
  templateUrl: './groupe-list-abonne.component.html'
})
export class GroupeListAbonneComponent implements OnInit {
    ...
    constructor( private service: GroupeAbonneService  , private groupeUtilisateurService: GroupeUtilisateurAbonneService, private utilisateurService: UtilisateurAbonneService, @Inject(PLATFORM_ID) private platformId?) {

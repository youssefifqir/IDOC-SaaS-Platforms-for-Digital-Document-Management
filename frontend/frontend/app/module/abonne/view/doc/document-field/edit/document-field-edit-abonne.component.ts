...
@Component({
  selector: 'app-document-field-edit-abonne',
  templateUrl: './document-field-edit-abonne.component.html'
})
export class DocumentFieldEditAbonneComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateDocument(document: string) {
        const isPermistted = await this.roleService.isPermitted('Document', 'edit');
        if (isPermistted) {

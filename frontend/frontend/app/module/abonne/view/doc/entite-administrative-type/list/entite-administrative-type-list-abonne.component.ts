...
@Component({
  selector: 'app-entite-administrative-type-list-abonne',
  templateUrl: './entite-administrative-type-list-abonne.component.html'
})
export class EntiteAdministrativeTypeListAbonneComponent implements OnInit {

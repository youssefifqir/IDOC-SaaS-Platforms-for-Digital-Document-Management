...
@Component({
  selector: 'app-entite-administrative-type-view-abonne',
  templateUrl: './entite-administrative-type-view-abonne.component.html'
})
export class EntiteAdministrativeTypeViewAbonneComponent implements OnInit {
    ...
    constructor(private service: EntiteAdministrativeTypeAbonneService){

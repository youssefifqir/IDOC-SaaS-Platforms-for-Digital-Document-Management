...
@Component({
  selector: 'app-entite-administrative-type-create-abonne',
  templateUrl: './entite-administrative-type-create-abonne.component.html'
})
export class EntiteAdministrativeTypeCreateAbonneComponent  implements OnInit {

...
@Component({
  selector: 'app-document-type-edit-abonne',
  templateUrl: './document-type-edit-abonne.component.html'
})
export class DocumentTypeEditAbonneComponent implements OnInit {

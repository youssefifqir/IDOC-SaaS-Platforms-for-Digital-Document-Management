...
@Component({
  selector: 'app-document-type-list-abonne',
  templateUrl: './document-type-list-abonne.component.html'
})
export class DocumentTypeListAbonneComponent implements OnInit {

    protected fileName = 'DocumentType';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DocumentTypeDto>();
    ...
    public async edit(dto: DocumentTypeDto) {
    ...
    public async view(dto: DocumentTypeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DocumentTypeDto) {
    ...
    public async duplicate(dto: DocumentTypeDto) {
    ...
    public exportPdf(dto: DocumentTypeDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<DocumentTypeDto> {
        return this.service.selections;
    }

    set selections(value: Array<DocumentTypeDto>) {

...
@Component({
  selector: 'app-document-type-view-abonne',
  templateUrl: './document-type-view-abonne.component.html'
})
export class DocumentTypeViewAbonneComponent implements OnInit {
    ...
    constructor(private service: DocumentTypeAbonneService){

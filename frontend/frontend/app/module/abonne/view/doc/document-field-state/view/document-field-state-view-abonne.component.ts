...
@Component({
  selector: 'app-document-field-state-view-abonne',
  templateUrl: './document-field-state-view-abonne.component.html'
})
export class DocumentFieldStateViewAbonneComponent implements OnInit {
    ...
    constructor(private service: DocumentFieldStateAbonneService){

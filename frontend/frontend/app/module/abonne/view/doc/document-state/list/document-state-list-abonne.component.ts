...
@Component({
  selector: 'app-document-state-list-abonne',
  templateUrl: './document-state-list-abonne.component.html'
})
export class DocumentStateListAbonneComponent implements OnInit {

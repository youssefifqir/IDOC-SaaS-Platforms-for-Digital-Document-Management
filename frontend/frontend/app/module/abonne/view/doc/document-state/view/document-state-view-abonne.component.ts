...
@Component({
  selector: 'app-document-state-view-abonne',
  templateUrl: './document-state-view-abonne.component.html'
})
export class DocumentStateViewAbonneComponent implements OnInit {
    ...
    constructor(private service: DocumentStateAbonneService){

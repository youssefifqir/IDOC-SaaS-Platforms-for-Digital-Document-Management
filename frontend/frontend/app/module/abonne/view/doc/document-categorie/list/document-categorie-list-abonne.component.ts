...
@Component({
  selector: 'app-document-categorie-list-abonne',
  templateUrl: './document-categorie-list-abonne.component.html'
})
export class DocumentCategorieListAbonneComponent implements OnInit {

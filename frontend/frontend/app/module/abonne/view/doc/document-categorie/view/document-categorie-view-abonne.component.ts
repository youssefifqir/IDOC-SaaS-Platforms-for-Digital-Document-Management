...
@Component({
  selector: 'app-document-categorie-view-abonne',
  templateUrl: './document-categorie-view-abonne.component.html'
})
export class DocumentCategorieViewAbonneComponent implements OnInit {
    ...
    constructor(private service: DocumentCategorieAbonneService){

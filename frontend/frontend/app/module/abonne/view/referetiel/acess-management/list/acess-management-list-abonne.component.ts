...
@Component({
  selector: 'app-acess-management-list-abonne',
  templateUrl: './acess-management-list-abonne.component.html'
})
export class AcessManagementListAbonneComponent implements OnInit {
    ...
    constructor( private service: AcessManagementAbonneService  , @Inject(PLATFORM_ID) private platformId?) {

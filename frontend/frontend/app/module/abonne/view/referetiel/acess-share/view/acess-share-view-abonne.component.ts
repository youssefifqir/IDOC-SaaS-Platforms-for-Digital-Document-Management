...
@Component({
  selector: 'app-acess-share-view-abonne',
  templateUrl: './acess-share-view-abonne.component.html'
})
export class AcessShareViewAbonneComponent implements OnInit {
    ...
    constructor(private service: AcessShareAbonneService){

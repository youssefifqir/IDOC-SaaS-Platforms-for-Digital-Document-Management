...
@Component({
  selector: 'app-acess-share-list-abonne',
  templateUrl: './acess-share-list-abonne.component.html'
})
export class AcessShareListAbonneComponent implements OnInit {

    protected fileName = 'AcessShare';
    ...
    constructor( private service: AcessShareAbonneService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AcessShareDto>();
    ...
    public async edit(dto: AcessShareDto) {
    ...
    public async view(dto: AcessShareDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AcessShareDto) {
    ...
    public async duplicate(dto: AcessShareDto) {
    ...
    public exportPdf(dto: AcessShareDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<AcessShareDto> {
        return this.service.selections;
    }

    set selections(value: Array<AcessShareDto>) {

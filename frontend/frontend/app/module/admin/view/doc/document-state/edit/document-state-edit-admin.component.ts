...
@Component({
  selector: 'app-document-state-edit-admin',
  templateUrl: './document-state-edit-admin.component.html'
})
export class DocumentStateEditAdminComponent implements OnInit {

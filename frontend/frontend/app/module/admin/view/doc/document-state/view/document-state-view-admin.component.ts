...
@Component({
  selector: 'app-document-state-view-admin',
  templateUrl: './document-state-view-admin.component.html'
})
export class DocumentStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: DocumentStateAdminService){

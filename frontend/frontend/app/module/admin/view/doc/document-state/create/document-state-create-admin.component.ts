...
@Component({
  selector: 'app-document-state-create-admin',
  templateUrl: './document-state-create-admin.component.html'
})
export class DocumentStateCreateAdminComponent  implements OnInit {

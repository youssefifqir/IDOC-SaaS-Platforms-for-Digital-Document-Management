...
@Component({
  selector: 'app-document-field-edit-admin',
  templateUrl: './document-field-edit-admin.component.html'
})
export class DocumentFieldEditAdminComponent implements OnInit {

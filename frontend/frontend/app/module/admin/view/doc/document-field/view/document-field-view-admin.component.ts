...
@Component({
  selector: 'app-document-field-view-admin',
  templateUrl: './document-field-view-admin.component.html'
})
export class DocumentFieldViewAdminComponent implements OnInit {
    ...
    constructor(private service: DocumentFieldAdminService, private fieldService: FieldAdminService, private documentFieldStateService: DocumentFieldStateAdminService, private documentService: DocumentAdminService){

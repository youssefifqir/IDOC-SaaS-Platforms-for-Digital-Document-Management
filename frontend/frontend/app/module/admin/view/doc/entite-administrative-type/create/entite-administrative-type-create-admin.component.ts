...
@Component({
  selector: 'app-entite-administrative-type-create-admin',
  templateUrl: './entite-administrative-type-create-admin.component.html'
})
export class EntiteAdministrativeTypeCreateAdminComponent  implements OnInit {

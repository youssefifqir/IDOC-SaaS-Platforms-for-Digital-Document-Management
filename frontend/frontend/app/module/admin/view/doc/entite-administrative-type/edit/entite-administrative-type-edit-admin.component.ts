...
@Component({
  selector: 'app-entite-administrative-type-edit-admin',
  templateUrl: './entite-administrative-type-edit-admin.component.html'
})
export class EntiteAdministrativeTypeEditAdminComponent implements OnInit {

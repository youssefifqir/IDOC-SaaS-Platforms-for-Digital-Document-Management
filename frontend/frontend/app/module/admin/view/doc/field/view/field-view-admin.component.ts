...
@Component({
  selector: 'app-field-view-admin',
  templateUrl: './field-view-admin.component.html'
})
export class FieldViewAdminComponent implements OnInit {
    ...
    constructor(private service: FieldAdminService){

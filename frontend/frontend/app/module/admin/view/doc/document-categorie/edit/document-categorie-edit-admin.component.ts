...
@Component({
  selector: 'app-document-categorie-edit-admin',
  templateUrl: './document-categorie-edit-admin.component.html'
})
export class DocumentCategorieEditAdminComponent implements OnInit {

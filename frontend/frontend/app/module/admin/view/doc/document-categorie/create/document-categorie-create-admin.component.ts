...
@Component({
  selector: 'app-document-categorie-create-admin',
  templateUrl: './document-categorie-create-admin.component.html'
})
export class DocumentCategorieCreateAdminComponent  implements OnInit {

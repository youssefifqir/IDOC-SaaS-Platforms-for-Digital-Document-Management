...
@Component({
  selector: 'app-document-categorie-view-admin',
  templateUrl: './document-categorie-view-admin.component.html'
})
export class DocumentCategorieViewAdminComponent implements OnInit {
    ...
    constructor(private service: DocumentCategorieAdminService){

...
@Component({
  selector: 'app-document-field-state-view-admin',
  templateUrl: './document-field-state-view-admin.component.html'
})
export class DocumentFieldStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: DocumentFieldStateAdminService){

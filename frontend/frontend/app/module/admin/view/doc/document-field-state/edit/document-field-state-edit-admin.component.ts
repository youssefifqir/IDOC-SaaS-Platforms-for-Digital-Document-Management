...
@Component({
  selector: 'app-document-field-state-edit-admin',
  templateUrl: './document-field-state-edit-admin.component.html'
})
export class DocumentFieldStateEditAdminComponent implements OnInit {

...
@Component({
  selector: 'app-document-field-state-list-admin',
  templateUrl: './document-field-state-list-admin.component.html'
})
export class DocumentFieldStateListAdminComponent implements OnInit {

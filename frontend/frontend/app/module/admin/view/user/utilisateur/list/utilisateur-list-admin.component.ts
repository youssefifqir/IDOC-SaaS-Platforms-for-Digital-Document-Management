...
export class UtilisateurListAdminComponent implements OnInit {
    ...
    constructor( private service: UtilisateurAdminService  , private abonneService: AbonneAdminService, @Inject(PLATFORM_ID) private platformId?) {

...
export class EntiteAdministrativeCreateAdminComponent  implements OnInit {
   ...
   private _validEntiteAdministrativeLibelle = true;
    ...
    validcodeEntiteAdminParent: boolean=true;

	constructor(private service: EntiteAdministrativeAdminService , private abonneService: AbonneAdminService, private entiteAdministrativeTypeService: EntiteAdministrativeTypeAdminService, private utilisateurService: UtilisateurAdminService, @Inject(PLATFORM_ID) private platformId? ) {

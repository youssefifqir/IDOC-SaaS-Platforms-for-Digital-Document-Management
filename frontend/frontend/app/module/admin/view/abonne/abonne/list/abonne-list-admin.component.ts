...
export class AbonneListAdminComponent implements OnInit {

    protected fileName = 'Abonne';
    ...
    constructor( private service: AbonneAdminService  , private entiteAdministrativeService: EntiteAdministrativeAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AbonneDto>();
    ...
    public async edit(dto: AbonneDto) {
    ...
    public async view(dto: AbonneDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AbonneDto) {
    ...
    public async duplicate(dto: AbonneDto) {
    ...
    public exportPdf(dto: AbonneDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<AbonneDto> {
        return this.service.selections;
    }

    set selections(value: Array<AbonneDto>) {
